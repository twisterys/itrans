...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Import  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('import.store')}}" id="form-horizontal" class="form-horizontal form-wizard-wrapper" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-import :drivers="$drivers" :typesFrais="$typeFrais" :typesVehicle="$typeVehicle" :vehicles="$vehicles" :import=null :plomos="$plomos" :clients="$clients" :transitaires="$transitaires" :chauffeurs="$chauffeurs">Ajouter</x-form-import>
                                    </form>
