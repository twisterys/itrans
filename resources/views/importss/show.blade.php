        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-white">
                    <a class="btn btn-secondary pull-right" href="{{route('import.index')}}">
                        Retour à la liste
                    </a>
                    <hr>
                </div>
                <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Véhicules</th>
                                                    <td>@foreach($import->dossierVehicles as $key => $vehicule)
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       {{App\Dossier::TYPE_CHARGEMENT[$import->type_chargement] ?? ''}}
                                                    </td>
                                                </tr>
                                    ...
                                    <tbody>
                                        @foreach($import->dossierVehicles as $key => $vehicule)
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($import->dossierItems as $key => $item)
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                @forelse ($import->dossierVehicles as $v)
                                            ...
                                            <td>
                                                @forelse ($import->plomos as $plomos)
                                    ...
                                    <tbody>
                                        @foreach($import->personalExpenses as $key => $expense)
                                        <tr>
