...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title')  Import Documents  @endslot
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('import.store_docs')}}" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="import_id" id="import_id" value="{{$import->id}}"/>
                         ...
                         <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($import->import_file->count()>0)


                                     <table class="table table-bordered table-striped">
                                        @foreach($import->import_file as $key => $media)
                                         <tr>
                                             <td>
                                     ...
                                     <div class="row col-12">
                                        <h4 class="mt-3 mx-auto alert alert-danger">Pas des fichiers pour cet import </h4>
