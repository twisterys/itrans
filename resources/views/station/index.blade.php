...
@section('title') Stations @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Stations  @endslot
         @slot('action')  <a class="btn btn-success " href="{{route('station.create')}}">Nouveau station </a>    @endslot
     @endcomponent
    ...
    <script type="text/javascript">
        ...
        function deleteStation(id){
            ...
            if (e.value === true) {
                ...
                var url = '{{ route("station.destroy", ":station") }}';
                url = url.replace(':station', id);
                $.ajax({
                    type: 'DELETE',
                    url: url,
