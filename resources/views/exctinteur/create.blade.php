...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Extincteur  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('vehicle.exctinteur.store',$vehicle->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-exctinteur :vehicle="$vehicle->id" :exctinteur=null>Ajouter</x-form-exctinteur>
                                    </form>
