...
@section('title') Depots @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Depots  @endslot
         @slot('action')  <a class="btn btn-success " href="{{route('depot.create')}}">Nouveau depot </a>    @endslot
     @endcomponent
    ...
    <script type="text/javascript">
        ...
        function deleteDepot(id){
            ...
            if (e.value === true) {
                ...
                var url = '{{ route("depot.destroy", ":depot") }}';
                url = url.replace(':depot', id);
                $.ajax({
                    type: 'DELETE',
                    url: url,
