...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Assurance Travail  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('assuranceTravail.store')}}" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-assurance-travail :assurance=null>Ajouter</x-form-assurance-travail>
                                    </form>
