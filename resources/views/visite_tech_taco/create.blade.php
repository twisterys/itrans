...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Visite Technique Pour Disque  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('taco.visiteTechnique.store',$taco->id)}}">
                                        @csrf
                                        <x-form-visite-tech-taco :taco="$taco->id" :visiteTechnique=null>Ajouter</x-form-visite-tech-taco>
                                    </form>
