...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title')  Type Vehicules  @endslot
         @slot('action')  <a class="btn btn-success " href="{{route('TypeVehicle.create')}}">Nouveau type vehicule </a>    @endslot
     @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function deleteTypeVehicle(typeVehicle){
            //alert(vehicle);
            swal.fire({
            title: "Supprimé?",
            icon: 'question',
            ...
            if (e.value === true) {
                ...
                var url = '{{ route("TypeVehicle.destroy", ":typeVehicle") }}';
                url = url.replace(':typeVehicle', typeVehicle);
                $.ajax({
                    type: 'DELETE',
                    url: url,
