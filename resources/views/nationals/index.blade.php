...
@section('title') Nationals @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Dossier Nationals  @endslot
         @slot('action')  <a class="btn btn-success " href="{{route('national.create')}}">Nouveau dossier </a>    @endslot
     @endcomponent
    ...
    table.column(index).search(value, strict).draw()
        ...
        function deleteNational(id){
            ...
            if (e.value === true) {
                ...
                var url = '{{ route("national.destroy", ":national") }}';
                url = url.replace(':national', id);
                $.ajax({
                    type: 'DELETE',
                    url: url,
