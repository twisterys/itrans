...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title')  National Documents  @endslot
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('national.store_docs')}}" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="dossier_id" id="dossier_id" value="{{$national->id}}"/>
                         ...
                         <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($national->national_file->count()>0)


                                     <table class="table table-bordered table-striped">
                                        @foreach($national->national_file as $key => $media)
                                         <tr>
                                             <td>
                                     ...
                                     <div class="row col-12">
                                        <h4 class="mt-3 mx-auto alert alert-danger">Pas des fichiers pour cet national </h4>
...
Dropzone.options.docDropzone = {
    ...
    success: function (file, response) {
        ...
        uploadednationalFileMap[file.name] = response.name
    },
    removedfile: function (file) {
      ...
      if (typeof file.file_name !== 'undefined') {
        ...
        name = uploadednationalFileMap[file.name]
      }
