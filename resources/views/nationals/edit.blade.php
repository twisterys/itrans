...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Modifier National  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('national.update',$national->id)}}" id="form-horizontal" class="form-horizontal form-wizard-wrapper">
                                        @csrf
                                        @method('PUT')
                                        <x-form-national :drivers="$drivers"  :typesFrais="$typeFrais" :typesVehicle="$typeVehicle" :national="$national" :vehicles="$vehicles" :plomos="$plomos" :clients="$clients" :transitaires="$transitaires" :chauffeurs="$chauffeurs">Modifier</x-form-national>
                                    </form>
