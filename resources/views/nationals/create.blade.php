...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter National  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('national.store')}}" id="form-horizontal" class="form-horizontal form-wizard-wrapper" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-national :drivers="$drivers" :typesFrais="$typeFrais" :typesVehicle="$typeVehicle" :national=null :vehicles="$vehicles" :plomos="$plomos" :clients="$clients" :transitaires="$transitaires" :chauffeurs="$chauffeurs">Ajouter</x-form-national>
                                    </form>
