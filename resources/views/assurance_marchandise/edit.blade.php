...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Modifier Assurances Marchandise  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('assuranceMarchandise.update',$assuranceMarchandise->id)}}">
                                        @csrf
                                        @method('PUT')
                                        <x-form-assurance-marchandise  :assurance="$assuranceMarchandise">Modifier</x-form-assurance-marchandise>
                                    </form>
...
@section('script')
   ...
   Dropzone.options.docDropzone = {
       ...
       removedfile: function (file) {
        ...
        init: function () {
            @if(isset($assuranceMarchandise) && $assuranceMarchandise->assurance_marchandise_file)
                    var files =
                        {!! json_encode($assuranceMarchandise->assurance_marchandise_file) !!}
                        for (var i in files) {
                        var file = files[i]
