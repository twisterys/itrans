...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Assurances Marchandise  @endslot
         @slot('action')  <a class="btn btn-success " href="{{route('assuranceMarchandise.create')}}">Nouvelle Assurance </a>    @endslot
     @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var table = $('#datatable-buttons').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('assuranceMarchandise.index') }}",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'type', name: 'type'},
                  {data: 'date', name: 'date'},
    ...
    table.column(index).search(value, strict).draw()
        ...
        function deleteAssuranceMarchandise(assurance){
            //alert(id);
            swal.fire({
            title: "Supprimé?",
            icon: 'question',
            ...
            if (e.value === true) {
                ...
                var url = '{{ route("assuranceMarchandise.destroy", ":assurance") }}';
