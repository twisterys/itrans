<h3>Véhicules</h3>
<fieldset>
<x-form-import-vehicle :v="$vehicles" :typeVehicle="$typesVehicle" :importVehicle="$national ? $national : null"></x-form-import-vehicle>
</fieldset>
<h3>National</h3>
<fieldset>
...
{{--            <div class="col-md-9">--}}
{{--                <input class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" name="date" type="date" value="{{old('date',$national ? $national->date : '')}}" id="example-date-input">--}}
{{--                @if($errors->has('date'))--}}
...
{{--    <div class="col-6">--}}
{{--        <div class="form-group row">--}}
{{--                <label class="col-md-3 col-form-label">Chauffeurs</label>--}}
{{--                <div class="col-md-8">--}}
{{--                    <select name="chauffeurs[]" class="select2 form-control select2-multiple " multiple="multiple" id="chauffeurs" data-placeholder="Choisir ...">--}}
{{--                            @foreach ($chauffeurs as $chauffeur)--}}
{{--                                --}}
{{--                                <option value="{{$chauffeur->id}}" {{ in_array($chauffeur->id, old('chauffeurs', [])) || ($national ? $national->chauffeur->contains($chauffeur->id) : null) ? 'selected' : '' }}>{{$chauffeur->nom.' '.$chauffeur->prenom.'('.$chauffeur->cin.')'}}</option>--}}
{{--                                --}}
{{--                            @endforeach--}}
{{--                    --}}
{{--                    </select>--}}
{{--            </div>--}}
{{--            <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-toggle="tooltip" title="Ajouter External Chauffeur" data-target=".modalChauffeur"><i class="bx bxs-comment-add"></i></button>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="col-6">--}}
{{--        <div class="form-group row ">--}}
{{--            <label for="example-text-input" class="col-md-3 col-form-label">Compagnie</label>--}}
{{--            <div class="col-md-9">--}}
{{--                <input class="form-control {{ $errors->has('compagnie') ? 'is-invalid' : '' }}" name="compagnie"  type="text" value="{{old('compagnie',$national ? $national->compagnie : '')}}" id="example-text-input">--}}
...
{{--    <div class="col-6">--}}
{{--        <div class="form-group row ">--}}
{{--            <label for="example-text-input" class="col-md-3 col-form-label">Navire</label>--}}
{{--            <div class="col-md-9">--}}
{{--                <input class="form-control {{ $errors->has('navire') ? 'is-invalid' : '' }}" name="navire"  type="text" value="{{old('navire',$national ? $national->navire : '')}}" id="example-text-input">--}}
...
{{--    <div class="col-6">--}}
{{--        <div class="form-group row ">--}}
{{--            <label for="example-text-input" class="col-md-3 col-form-label">provenance</label>--}}
{{--            <div class="col-md-9">--}}
{{--                <input class="form-control {{ $errors->has('provenance') ? 'is-invalid' : '' }}" name="provenance"  type="text" value="{{old('provenance',$national ? $national->provenance : '')}}" id="example-text-input">--}}
...
{{--        <div class="col-6">--}}
{{--            <div class="form-group row">--}}
{{--                <label class="col-md-3 col-form-label" for="type_chargement">Type Chargement</label>--}}
{{--                <div class="col-md-9">--}}
...
{{--                            <option value="{{ $key }}" {{ old('type_chargement',$national ? $national->type_chargement : '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>--}}
{{--                        @endforeach--}}
{{--                    </select>--}}
...
{{--        <div class="col-6">--}}
{{--            <div class="form-group row">--}}
{{--                <label for="example-number-input" class="col-md-3 col-form-label">Kilometrage</label>--}}
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('kilometrage') ? 'is-invalid' : '' }}" name="kilometrage" type="number" value="{{old('kilometrage',$national ? $national->kilometrage : '')}}" id="example-number-input" step=0.01>--}}
...
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('nb_jour_maroc') ? 'is-invalid' : '' }}" name="nb_jour_maroc" type="number" value="{{old('nb_jour_maroc',$national ? $national->nb_jour_maroc : '')}}" id="example-number-input" step=1>--}}
...
{{--        <div class="col-6">--}}
{{--            <div class="form-group row ">--}}
{{--                <label for="example-text-input" class="col-md-3 col-form-label">Observation</label>--}}
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('observation') ? 'is-invalid' : '' }}" name="observation"  type="text" value="{{old('observation',$national ? $national->observation : '')}}" id="example-text-input">--}}
...
{{--=======--}}
        ...
        <div class="col-6">
            <div class="form-group row ">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('destination') ? 'is-invalid' : '' }}" name="destination"  type="text" value="{{old('destination',$national ? $national->destination : '')}}" id="example-text-input">
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('date_sortie') ? 'is-invalid' : '' }}" name="date_sortie" type="date" value="{{old('date_sortie',$national ? $national->date_sortie : '')}}" id="example-date-input">
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('date_arrive') ? 'is-invalid' : '' }}" name="date_arrive" type="date" value="{{old('date_arrive',$national ? $national->date_arrive : '')}}" id="example-date-input">
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('tarre') ? 'is-invalid' : '' }}" name="tarre" type="number" value="{{old('tarre',$national ? $national->tarre : '')}}" id="example-number-input" step=0.01>
                        @if($errors->has('tarre'))
                            <div class="invalid-feedback">
                                {{ $errors->first('tarre') }}
                            </div>
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('poid_brut') ? 'is-invalid' : '' }}" name="poid_brut" type="number" value="{{old('poid_brut',$national ? $national->poid_brut : '')}}" id="example-number-input" step=0.01>
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('nbr_colis') ? 'is-invalid' : '' }}" name="nbr_colis" type="number" value="{{old('nbr_colis',$national ? $national->nbr_colis : '')}}" id="example-number-input">
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('nb_jour_etranger') ? 'is-invalid' : '' }}" name="nb_jour_etranger" type="number" value="{{old('nb_jour_etranger',$national ? $national->nb_jour_etranger : '')}}" id="example-number-input" step=1>
                        ...
                        <div class="col-md-9">
                            <select name="plomos[]" class="select2 form-control select2-multiple " multiple="multiple" data-placeholder="Choisir ...">
                                    @foreach ($plomos as $plomo)
                                        ...
                                        <option value="{{$plomo->id}}" {{ in_array($plomo->id, old('plomos', [])) || ($national ? $national->plomos->contains($plomo->id) : null) ? 'selected' : '' }}>{{$plomo->num_serie}}</option>
...
<h3>National Items</h3>
<fieldset>
    <x-form-import-item  :importItem="$national ? $national : null" :clients="$clients" :transitaires="$transitaires"></x-form-import-item>
</fieldset>

<h3>Frais</h3>
<fieldset>

<x-form-personal-expenses :typeFrais="$typesFrais" :personalExpense="$national ? $national : null"></x-form-personal-expenses>
