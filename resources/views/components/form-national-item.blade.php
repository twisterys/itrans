        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Fiche Détail National</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client"  type="text" value="{{old('client',$nationalItem ? $nationalItem->client : '')}}" id="client" >
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('importateur') ? 'is-invalid' : '' }}" name="importateur"  type="text" value="{{old('importateur',$nationalItem ? $nationalItem->importateur : '')}}" id="importateur">
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control {{ $errors->has('exportateur') ? 'is-invalid' : '' }}" name="exportateur" value="{{old('exportateur',$nationalItem ? $nationalItem->exportateur : '')}}" rows="3" id="exportateur"></textarea>
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('transitaire') ? 'is-invalid' : '' }}" name="transitaire"  type="text" value="{{old('transitaire',$nationalItem ? $nationalItem->transitaire : '')}}" id="transitaire">
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('marchandise') ? 'is-invalid' : '' }}" name="marchandise"  type="text" value="{{old('marchandise',$nationalItem ? $nationalItem->marchandise : '')}}" id="marchandise">
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('dum') ? 'is-invalid' : '' }}" name="dum"  type="text" value="{{old('dum',$nationalItem ? $nationalItem->dum : '')}}" id="dum">
                                @if($errors->has('dum'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('dum') }}
                                    </div>
                    ...
                    <div class="col-11">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('numb_colis') ? 'is-invalid' : '' }}" name="numb_colis" type="number" value="{{old('numb_colis',$nationalItem ? $nationalItem->numb_colis : '')}}" id="numb_colis">
                    ...
                    <div class="col-11">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control {{ $errors->has('poid_brute') ? 'is-invalid' : '' }}" name="poid_brute" type="number" value="{{old('poid_brute',$nationalItem ? $nationalItem->poid_brute : '')}}" id="poid_brute" step=0.01>
                    ...
                    <div class="col-11">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control {{ $errors->has('observ') ? 'is-invalid' : '' }}" name="observ" value="{{old('observ',$nationalItem ? $nationalItem->observ : '')}}" rows="3" id="observ"></textarea>
...
<script>
    function deleteItem(index){
        if (confirm("Are you sure?")) {
            ...
            $('input[name=nationalItems]').val(JSON.stringify(total));
...
<script>
    var total = new Array();
    total = $('input[name=nationalItems]').val()
    ...
    $(document).ready(function() {
        ...
        if(total){ 
            ...
            total = <?php echo (!empty($nationalItem) ?  json_encode($nationalItem->nationalItems) : 'new Array()'); ?>
        }
