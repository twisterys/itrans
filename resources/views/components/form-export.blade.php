<h3>Véhicules</h3>
<fieldset>
<x-form-import-vehicle :v="$vehicles" :typeVehicle="$typesVehicle" :importVehicle="$export ? $export : null"></x-form-import-vehicle>
</fieldset>
<h3>Export</h3>
<fieldset>
...
{{--            <div class="col-md-9">--}}
{{--                <input class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" name="date" type="date" value="{{old('date',$export ? $export->date : '')}}" id="example-date-input">--}}
{{--                @if($errors->has('date'))--}}
...
{{--                                --}}
{{--                                <option value="{{$chauffeur->id}}" {{ in_array($chauffeur->id, old('chauffeurs', [])) || ($export ? $export->chauffeur->contains($chauffeur->id) : null) ? 'selected' : '' }}>{{$chauffeur->nom.' '.$chauffeur->prenom.'('.$chauffeur->cin.')'}}</option>--}}
{{--                                --}}
{{--                            @endforeach--}}
{{--=======--}}
    <div class="row">
...
{{--                            <option value="{{ $key }}" {{ old('type_chargement',$export ? $export->type_chargement : '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>--}}
{{--                        @endforeach--}}
{{--                    </select>--}}
...
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('kilometrage') ? 'is-invalid' : '' }}" name="kilometrage" type="number" value="{{old('kilometrage',$export ? $export->kilometrage : '')}}" id="example-number-input" step=0.01>--}}
...
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('nb_jour_maroc') ? 'is-invalid' : '' }}" name="nb_jour_maroc" type="number" value="{{old('nb_jour_maroc',$export ? $export->nb_jour_maroc : '')}}" id="example-number-input" step=1>--}}
...
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('nb_jour_etranger') ? 'is-invalid' : '' }}" name="nb_jour_etranger" type="number" value="{{old('nb_jour_etranger',$export ? $export->nb_jour_etranger : '')}}" id="example-number-input" step=1>--}}
...
{{--                <div class="col-md-9">--}}
{{--                    <input class="form-control {{ $errors->has('observation') ? 'is-invalid' : '' }}" name="observation"  type="text" value="{{old('observation',$export ? $export->observation : '')}}" id="example-text-input">--}}
...
{{--                                @foreach ($plomos as $plomo)--}}
        ...
        <div class="col-6">
            <div class="form-group row ">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('compagnie') ? 'is-invalid' : '' }}" name="compagnie"  type="text" value="{{old('compagnie',$export ? $export->compagnie : '')}}" id="example-text-input">
        ...
        <div class="col-6">
            <div class="form-group row ">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('provenance') ? 'is-invalid' : '' }}" name="provenance"  type="text" value="{{old('provenance',$export ? $export->provenance : '')}}" id="example-text-input">
        ...
        <div class="col-6">
            <div class="form-group row ">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('destination') ? 'is-invalid' : '' }}" name="destination"  type="text" value="{{old('destination',$export ? $export->destination : '')}}" id="example-text-input">
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('date_sortie') ? 'is-invalid' : '' }}" name="date_sortie" type="date" value="{{old('date_sortie',$export ? $export->date_sortie : '')}}" id="example-date-input">
        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control {{ $errors->has('date_arrive') ? 'is-invalid' : '' }}" name="date_arrive" type="date" value="{{old('date_arrive',$export ? $export->date_arrive : '')}}" id="example-date-input">
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('tarre') ? 'is-invalid' : '' }}" name="tarre" type="number" value="{{old('tarre',$export ? $export->tarre : '')}}" id="example-number-input" step=0.01>
                        @if($errors->has('tarre'))
                            <div class="invalid-feedback">
                                {{ $errors->first('tarre') }}
                            </div>
            ...
            <div class="col-6">
                <div class="form-group row ">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('navire') ? 'is-invalid' : '' }}" name="navire"  type="text" value="{{old('navire',$export ? $export->navire : '')}}" id="example-text-input">
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('poid_brut') ? 'is-invalid' : '' }}" name="poid_brut" type="number" value="{{old('poid_brut',$export ? $export->poid_brut : '')}}" id="example-number-input" step=0.01>
            ...
            <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control {{ $errors->has('nbr_colis') ? 'is-invalid' : '' }}" name="nbr_colis" type="number" value="{{old('nbr_colis',$export ? $export->nbr_colis : '')}}" id="example-number-input">
                        ...
                        <div class="col-md-9">
                            <select name="plomos[]" class="select2 form-control select2-multiple " multiple="multiple" data-placeholder="Choisir ...">
                                    @foreach ($plomos as $plomo)
                                        ...
                                        <option value="{{$plomo->id}}" {{ in_array($plomo->id, old('plomos', [])) || ($export ? $export->plomos->contains($plomo->id) : null) ? 'selected' : '' }}>{{$plomo->num_serie}}</option>
...
<h3>Export Items</h3>
<fieldset>
    <x-form-import-item  :importItem="$export ? $export : null" :clients="$clients" :transitaires="$transitaires"></x-form-import-item>
</fieldset>

<h3>Frais</h3>
<fieldset>

<x-form-personal-expenses :typeFrais="$typesFrais" :personalExpense="$export ? $export : null"></x-form-personal-expenses>
