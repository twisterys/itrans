...
<div class="col-4">
    <div class="form-group row">
        <label for="example-text-input" class="col-md-3 col-form-label">Assureur<span>(<i style="font-size: 6px;" class="fas fa-asterisk text-danger"></i>)</span></label>
        <div class="col-md-9">
...
<div class="col-4">
    <div class="form-group row">
        <label for="example-text-input" class="col-md-3 col-form-label">Police<span>(<i style="font-size: 6px;" class="fas fa-asterisk text-danger"></i>)</span></label>
        <div class="col-md-9">
