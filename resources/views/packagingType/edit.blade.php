...
@section('title') Type Packaging @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') Modifier Type Packaging  @endslot
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('TypePackaging.update',$TypePackaging->id)}}">
                        @csrf
                        @method('PUT')
                        <x-form-type-packaging :typePackaging="$TypePackaging">Modifier</x-form-type-packaging>
                    </form>
