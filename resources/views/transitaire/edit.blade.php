...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Modifier Transitaire  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('transitaire.update',$transitaire->id)}}">
                                        @csrf
                                        @method('PUT')
                                        <x-form-transitaire :transitaire="$transitaire">Modifier</x-form-transitaire>
                                    </form>
