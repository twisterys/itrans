...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Disque  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('vehicle.taco.store',$vehicle->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-taco :vehicle="$vehicle->id" :taco=null>Ajouter</x-form-taco>
                                    </form>
