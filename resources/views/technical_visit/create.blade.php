...
@section('css')
    ...
    <link href="{{ asset('libs/jquery-ui/dropzone.min.css')}}" rel="stylesheet" />    @endsection

@section('content')

    @component('common-components.breadcrumb')
         @slot('title') Ajouter Visite Technique  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('vehicle.technicalVisit.store',$vehicle->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-technical-visit :vehicle="$vehicle->id" :technicalVisit=null>Ajouter</x-form-technical-visit>
                                    </form>
