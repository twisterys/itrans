...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Modifier Export  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('export.update',$export->id)}}" id="form-horizontal" class="form-horizontal form-wizard-wrapper" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <x-form-export :drivers="$drivers" :typesFrais="$typeFrais" :export="$export" :typesVehicle="$typeVehicle" :vehicles="$vehicles" :plomos="$plomos" :clients="$clients" :transitaires="$transitaires" :chauffeurs="$chauffeurs">Modifier</x-form-export>
                                    </form>
