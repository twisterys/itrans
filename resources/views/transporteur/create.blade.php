...
@section('title') Transporteur @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Transporteur  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('transporteur.store')}}">
                                        @csrf
                                        <x-form-transporteur :transporteur=null>Ajouter</x-form-transporteur>
                                    </form>
