...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Ajouter Assurance  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('vehicle.assurance.store',$vehicle->id)}}" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <x-form-assurance :vehicle="$vehicle->id" :assurance=null>Ajouter</x-form-assurance>
                                    </form>
