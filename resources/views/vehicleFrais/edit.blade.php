...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') Modifier Type Frais  @endslot
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('TypeFrais.update',$TypeFrai->id)}}">
                                        @csrf
                                        @method('PUT')
                                        <x-form-type-frais :typeFrais="$TypeFrai">Modifier</x-form-type-frais>
                                    </form>
